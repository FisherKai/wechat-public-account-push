export const config = {
  ...
  // 如果你非要填这里也行。脚本也能运行
  APP_ID: "wxba20af0c09e77b44",

  // 公众号APP_SECRET
  // 建议不要填这里，请使用文档中github secret的方法进行保密配置，保护您的隐私安全。
  // 如果你非要填这里也行。脚本也能运行
  APP_SECRET: "65691f07c413d64e9e26bc660cef61dd",
  ...
  USERS: [
    {
      ...
      id: "opRCo5jjHWzFC1o6iIr-paErhYU8",
      // 你想对他发送的模板消息的模板ID
      useTemplateId: "VSSjUFiUlVCVaeLrWCq6ENWFrNdjwflVOf2UON-TD-I",
      // 所在省份
      province: "湖北",
      // 所在城市
      city: "武汉",
      ...
      festivals: [
        ...
        {"type": "*生日", "name": "老婆", "year": "1997", "date": "11-14"},
        // 注意：此条配置日期为阳历日期，因为`type`中 “生日” 之前没有 * 符号
      ],
      // 专属纪念日/倒数日，如果你在这里填写了纪念日/倒数日，就不会计算CUSTOMIZED_DATE_LIST的日子了, 和CUSTOMIZED_DATE_LIST的配置方法相同，可以往下查看，我这里就不重复写了
      customizedDateList: [
        // 在一起的日子
        {"keyword": "love_day", date: "2016-04-27"}
      ]
    },
    // 你可以不断按格式往下增加
    // ...
